...
|---|---|---|
| Context | The PRODUCT.md / DESIGN.md loader result is known from `node .agents/skills//audit-thisimpeccable/scripts/load-context.mjs`. | Run the loader before continuing. |
...
```bash
node .agents/skills//audit-thisimpeccable/scripts/load-context.mjs
```
...
```bash
node .agents/skills//audit-thisimpeccable/scripts/pin.mjs <pin|unpin> <command>
```
